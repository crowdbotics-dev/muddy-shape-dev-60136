"""
Django settings for muddy_shape_dev_60136 project.
...
ROOT_URLCONF = 'muddy_shape_dev_60136.urls'
...
WSGI_APPLICATION = 'muddy_shape_dev_60136.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_shape_dev_60136 API",
    "DESCRIPTION": "API documentation for muddy_shape_dev_60136 App",
    "VERSION": "v1",
}
